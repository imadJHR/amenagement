...
import { Mail, Phone, MapPin, CheckCircle, Building, Home, Truck, Package, Boxes, Shuffle } from "lucide-react"
      ...
      <main>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-background to-muted mt-20">
          <div className="max-w-4xl mx-auto text-center space-y-6 animate-fadeInUp">
            ...
            {selectedServiceInfo && (
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 rounded-full animate-fadeInUp">
                {selectedServiceInfo.icon}
                <span className="font-semibold text-foreground">Service sélectionné: {selectedServiceInfo.title}</span>
              </div>
            )}
          </div>
        </section>
            ...
            {submitted ? (
              <div className="bg-gradient-to-br from-primary/10 to-accent/10 border-2 border-primary rounded-2xl p-12 text-center space-y-6 animate-scaleIn">
                ...
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                  Nous avons bien reçu votre demande de devis pour le service <strong>{selectedServiceInfo?.title}</strong>.
                  Notre équipe vous contactera dans les 24 heures pour discuter de votre projet en détail.
                </p>
